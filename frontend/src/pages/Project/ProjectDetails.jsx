...
import { fetchProjectById, inviteToProject } from "@/redux/Project/Project.Action"
...
const ProjectDetails = () => {
  ...
  return (
    <>
      {!project.loading ? (
        <div className="mt-5 lg:px-10 min-h-screen bg-[hsl(var(--background))] text-[hsl(var(--foreground))]">
